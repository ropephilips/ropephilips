...
export default function Project() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Optimize keywords and structure contents, search engine indexing for a startup",
    },
   
    {
      ...
      description: "Business visibility audit",
    },
    {
      id: 6,
  ...
  return (
    <section id="projects" ref={sectionRef} className="relative min-h-[450vh] bg-green-50">
      <div className="sticky top-0 flex flex-col md:flex-row items-center justify-between h-screen px-6 md:px-16">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-4 md:pl-6">
          ...
          <p className="tracking-[0.35em] md:tracking-[0.50em] text-xs text-green-700 mb-4 md:mb-10">
            some use case projects
          </p>
          <p className="text-amber-400 mb-4 max-w-md mx-auto md:mx-0 font-sans text-sm tracking-tighter">
            We build intelligent, automated, and sustainable systems that
            combine precision and professionalism. 
            Scroll to see some clients request and our solution.
          </p>

          <button className="gradient-ring relative px-6 py-3 rounded-full text-white font-semibold">
            See More Details
          </button>
            ...
            return (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-700 px-3 font-serif tracking-tight">
                    {project.description}
                  </p>
                </div>
              </motion.div>
